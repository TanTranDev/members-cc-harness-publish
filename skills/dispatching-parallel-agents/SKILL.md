...
- Agents would interfere with each other (GHI file: hết interfere khi mỗi agent một worktree riêng — xem vendor note đầu file)
...
**Shared state:** Agents would interfere (editing same files, using same resources) — riêng trường hợp GHI file: hết interfere khi mỗi agent một worktree riêng + scope không giao nhau (xem vendor note đầu file)
