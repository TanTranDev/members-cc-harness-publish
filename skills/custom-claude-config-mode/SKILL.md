...
description: "Đổi mode quality|balance|usage của bộ khung cho clone này. Triggers: /custom-claude-config-mode, \"mode tiết kiệm\", \"usage mode\", \"về quality\", \"đổi config-mode\"."
---
